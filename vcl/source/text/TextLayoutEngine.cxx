                                             ...
                                             std::optional<tools::Rectangle>* pBounds)
{
    ...
    std::unique_ptr<SalLayout> pSalLayout
        = Layout(rRes, aNormalizedSpan, aConstraints, rCache, vcl::text::RenderSelection{});
                                  ...
                                  const vcl::TextLayoutCommon& rLayout)
{
    ...
    else
    {
        ...
        // Use modern DrawTextFlags::Ellipsis
        if (aRes.nMaxWidth > nAvailableWidth && (rReq.nStyle & TEXT_DRAW_ELLIPSIS))
        {
            ...
            aRes.nMaxWidth = rLayout.GetTextWidth(aRes.aDisplayText, 0, -1);
            aRes.bEllipsisGenerated = true;
        }
    }

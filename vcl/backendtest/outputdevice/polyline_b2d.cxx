...
void drawPolyLineOffset(OutputDevice& rDevice, tools::Rectangle const& rRect, int nOffset)
{
...

    {
        ...
        aStroke.fWidth = 0.0;
        rDevice.DrawPolyLine(aPolygon, aStroke);
    } // draw hairline
}
...
Bitmap OutputDeviceTestPolyLineB2D::setupDiamond()
{
    ...
    {
        vcl::rendercontext::StrokeAttributes aStroke;
        mpVirtualDevice->DrawPolyLine(aPolygon, aStroke);
    }
...
Bitmap OutputDeviceTestPolyLineB2D::setupHalfEllipse(bool aEnableAA)
{
    ...
    {
        vcl::rendercontext::StrokeAttributes aStroke;
        mpVirtualDevice->DrawPolyLine(OutputDeviceTestCommon::createHalfEllipsePolygon(), aStroke);
    }
...
Bitmap OutputDeviceTestPolyLineB2D::setupOpenBezier()
{
    ...
    {
        vcl::rendercontext::StrokeAttributes aStroke;
        mpVirtualDevice->DrawPolyLine(OutputDeviceTestCommon::createOpenBezier(), aStroke);
    }

...
namespace
{
    ...
    GtkWidget* image_new_from_virtual_device(const VirtualDevice& rImageSurface)
    {
        ...
        Size aSize(rImageSurface.GetSizeInPixels());
...
private:
    ...
    void use_custom_content(VirtualDevice* pDevice)
    {
        ...
        Size aSize = pDevice->GetSizeInPixels();
...
private:
    ...
    void signal_draw(cairo_t* cr)
    {
        ...
        aRect = m_xDevice->GetGeometry().PixelToLogic(aRect);
    ...
    virtual void signal_size_allocate(guint nWidth, guint nHeight) override
    {
        ...
        if (m_pSurface && aNewSize == m_xDevice->GetSizeInPixels())
        {
            // unchanged
            return;
        }

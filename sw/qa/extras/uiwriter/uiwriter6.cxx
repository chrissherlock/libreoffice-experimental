...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf44773)
{
    ...
    Point aFrom = rEditWin.convertTo<vcl::WindowPoint>(vcl::LogicPoint(ptFrom));
    ...
    Point aTo = rEditWin.convertTo<vcl::WindowPoint>(vcl::LogicPoint(ptTo));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf161261)
{
    ...
    Point aFromHandle = rEditWin.convertTo<vcl::WindowPoint>(vcl::LogicPoint(ptFromHandle));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf161332)
{
    ...
    Point aFrom2 = rEditWin.convertTo<vcl::WindowPoint>(vcl::LogicPoint(ptFrom2));
...
CPPUNIT_TEST_FIXTURE(SwUiWriterTest6, testTdf161426_content)
{
    ...
    Point aFrom3 = rEditWin.convertTo<vcl::WindowPoint>(vcl::LogicPoint(ptFrom3));
    ...
    Point aFrom4 = rEditWin.convertTo<vcl::WindowPoint>(vcl::LogicPoint(ptFrom4));

                                               ...
                                               const SwTwips nDragDistance)
{
    ...
    const Point aFromPixels = rEditWin.convertTo<vcl::WindowPoint>(vcl::LogicPoint(aDragPoint));
    const Point aToPixels
        = rEditWin.convertTo<vcl::WindowPoint>(vcl::LogicPoint(aDestinationPoint));
